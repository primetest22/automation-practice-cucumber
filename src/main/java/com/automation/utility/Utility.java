...
//*************************** Action Methods ***************************************//
    ...
    //For lists of different elements
     public List<WebElement> waitUntilVisibilityOfElementLocated(List<WebElement> webElement, int time){
        List<WebElement> wait = new WebDriverWait(driver,Duration.ofSeconds(time))
                .until(ExpectedConditions.visibilityOfAllElements(webElement));
        return wait;
     }
    //For one element of type webelement
    public WebElement waitUntilVisibilityOfElementLocated(WebElement webElement, int time) {
        WebElement wait = new WebDriverWait(driver, Duration.ofSeconds(time))
